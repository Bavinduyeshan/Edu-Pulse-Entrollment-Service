//package com.EduPulse.EduPulse.config;
//
...
//                        .requestMatchers("/api/users/grades").permitAll() // Allow grade list for discovery
...
package com.Edupulse.EntrollmentService.config;
